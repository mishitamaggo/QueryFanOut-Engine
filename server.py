...
<body>
      ...
      <div class="controls-grid">
        <div class="control-item">
          ...
          <select id="modelSelect">
            <option value="openai/gpt-4o-mini" selected>OpenAI: GPT-4o Mini (Fast & Recommended)</option>
  ...
  <script>
    ...
    async function runFanOut() {
      ...
      if (!prompt) {
        alert("Please enter a prompt or select a sample question first.");
        return;
      }
      ...
      queries.forEach((q) => {
        ...
        card.innerHTML = `
          ...
          <div class="card-bottom-bar">
            ...
            <button class="btn-card-copy" onclick="copySingleQuery(this, '${escapeForAttribute(q.query)}')">Copy</button>
          </div>
        `;
    ...
    function copySingleQuery(buttonEl, text) {
      navigator.clipboard.writeText(text);
      const originalText = buttonEl.innerText;
      buttonEl.innerText = "Copied ✓";
      buttonEl.style.backgroundColor = "var(--orange-primary)";
